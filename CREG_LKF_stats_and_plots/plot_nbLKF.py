...
plt.figure(1)
plt.plot(df1['nb_of_LKFS'],color = "darkviolet")
plt.plot(df2['nb_of_LKFS'],color = "dodgerblue")
plt.plot(df3['nb_of_LKFS'],color = "orange")
#plt.plot(x, y2, marker='o')
#plt.plot(x, y3, marker='o')
#plt.ylim(4, 5)
#plt.xlim(1.1, 2.1)
#plt.legend([label1, label2, label3], loc ="lower right")
plt.ylabel('Number of LKFs',fontsize='14')
